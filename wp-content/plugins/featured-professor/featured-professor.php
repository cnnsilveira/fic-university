...
/*
  ...
  Version: 1.0.0
  Author: Caio Nunes
  Author URI: https://www.github.com/cnnsilveira
...
class FeaturedProfessor {
  ...
  function onInit() {
    load_plugin_textdomain('featured-professor', false, dirname(plugin_basename(__FILE__)).'/lang');
    ...
    wp_set_script_translations('featuredProfessorScript', 'featured-professor', plugin_dir_path(__FILE__).'/lang');
