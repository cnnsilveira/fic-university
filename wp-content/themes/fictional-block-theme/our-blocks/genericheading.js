...
registerBlockType("ourblocktheme/genericheading", {
    title: "University Generic Heading",
    attributes: {
...
function EditComponent(props) {
    ...
    return (
        <>
            ...
            <RichText allowedFormats={[]} tagName="h1" className={`headline headline--${props.attributes.size}`} value={props.attributes.text} onChange={handleTextChange} />
        </>
    )
}
