...
class HeroSlider {
  constructor() {
    ...
    allSlideshows.forEach(slide => {
      // count how many slides there are
      const dotCount = slide.querySelectorAll(".hero-slider__slide").length;
      ...
      slide.querySelector(".glide__bullets").insertAdjacentHTML("beforeend", dotHTML);

      // Actually initialize the glide / slider script
      var glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"](slide, {
        type: "carousel",
        perView: 1,
        autoplay: 3000
      });
...
class Search {
  ...
  // 3. Methods
  typingLogic() {
    if (this.searchField.val() != this.previousValue && jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(':focus')) {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), results => {
      this.resultsDiv.html(`
                <div class="row">
                    <div class="one-third">
                        <h2 class="search-overlay__section-title">General Informatin</h2>
  ...
  keyPressDispatcher(e) {
    if (e.keyCode == 83 && !this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()('*').is(':focus')) {
      this.openOverlay();
    }
