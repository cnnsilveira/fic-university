<?php
    ...
    function university_files() {
        wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyCSlTC7klxWifaXWDf84Vj0xLycWlKmuAU', null, '1.0', true);
    ...
    function university_map_key($api) {
        $api['key'] = 'AIzaSyCSlTC7klxWifaXWDf84Vj0xLycWlKmuAU';
        return $api;
    }
    ...
    add_filter('show_admin_bar', 'noSubsAdminBar'); 
 
    function noSubsAdminBar($show_admin_bar) {
        $ourCurrentUser = wp_get_current_user();
        return (count($ourCurrentUser->roles) == 1 AND $ourCurrentUser->roles[0] == 'subscriber') ? false : $show_admin_bar;
    }

    // Costumize login screen
    ...
    function myAllowedBlocks($allowed_block_types, $editor_context) {
        ...
        return array('ourblocktheme/slider');
    }
